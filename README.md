...
The simulation's parameters are stored in a Parquet file located at `constants/constants.parquet`. This file is generated by the `create_constants.py` script. Before running the main simulation, you will need to generate this file. Also, there is an output directory specified (hardcoded) at the top of the file, make sure that it exists and it points to your intended location.
